...
import com.lazycowprojects.lazyalarm.R;
...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIncrementButton = (NumberPickerButton) findViewById(R.id.incrementButton);
        mIncrementButton.setOnClickListener(this);
        mIncrementButton.setOnLongClickListener(this);
        mIncrementButton.setNumberPicker(this);
        mDecrementButton = (NumberPickerButton) findViewById(R.id.decrementButton);
    ...
    public void onClick(View v) {
        ...
        if (R.id.incrementButton == v.getId()) {
            changeCurrent(mCurrent + 1);
        } else if (R.id.decrementButton == v.getId()) {
            changeCurrent(mCurrent - 1);
        }
    }
